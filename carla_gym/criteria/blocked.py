...
class Blocked:
    def __init__(self, speed_threshold=0.1, below_threshold_max_time=30.0):
    ...
    def tick(self, vehicle, timestamp):
        info = None
        linear_speed = self.calculate_speed(vehicle.get_velocity())
    ...
    @staticmethod
    def calculate_speed(carla_velocity):
