class RouteDeviation:
    def __init__(self, offroad_min=10, offroad_max=20, max_route_percentage=0.3):
        self._offroad_min = offroad_min
        self._offroad_max = offroad_max  # Max Off-Route Distance at each time
    ...
    def tick(self, vehicle, timestamp, ref_waypoint, distance_traveled, route_length):
        ...
        # fail if the accumulation of off_safe_route more than 30% of total route length
        off_route_min = False
