    ...
    def tick(self, vehicle, timestamp):
        ...
        if self._target_stop_sign is None:
            ...
            if not self._stop_completed:
                # check whether the ego-vehicle stops
            ...
            if not self._affected_by_stop:
                stop_transform = self._target_stop_sign.get_transform()
                transformed_tv = stop_transform.transform(self._target_stop_sign.trigger_volume.location)
