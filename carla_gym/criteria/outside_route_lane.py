...
class OutsideRouteLane:
    def __init__(self, carla_map, vehicle_loc,
                 allowed_out_distance=1., max_allowed_vehicle_angle=120.0, max_allowed_waypoint_angle=150.0):
        self._map = carla_map
        ...
        self._max_allowed_waypoint_angle = max_allowed_waypoint_angle
    ...
    def _is_outside_driving_lanes(self, location):
        ...
        # Get the distance between current location and the center of the closest lane.
    ...
    def _is_at_wrong_lane(self, location, yaw):
        ...
        # Ignore if vehicle is at junctions, since lanes and roads are too chaotic at junctions
        if current_waypoint.is_junction:
            ...
            if self._pre_ego_waypoint.is_junction:
                ...
                vehicle_lane_angle = cast_angle(current_waypoint.transform.rotation.yaw - yaw)
                ...
                if abs(waypoint_angle) >= self._max_allowed_waypoint_angle:
